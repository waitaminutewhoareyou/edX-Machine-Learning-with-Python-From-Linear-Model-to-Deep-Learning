...
rectified_linear_unit_derivative = np.vectorize(rectified_linear_unit_derivative)
output_layer_activation_derivative = np.vectorize(output_layer_activation_derivative)
class NeuralNetwork():
    """
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_error = np.multiply( np.multiply(self.hidden_to_output_weights.T, output_layer_error) , rectified_linear_unit_derivative( hidden_layer_weighted_input)) # TODO (3 by 1 matrix)
        bias_gradients = hidden_layer_error# TODO
        hidden_to_output_weight_gradients =  (hidden_layer_activation * output_layer_error).T # TODO
        input_to_hidden_weight_gradients =  np.hstack((hidden_layer_error * x1, hidden_layer_error*x2))   # TODO
