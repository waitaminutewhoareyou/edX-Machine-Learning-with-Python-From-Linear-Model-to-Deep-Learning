...
sys.path.append("C:/Users/JI YIHONG/Dropbox/Edx/Machine Learning with Pytho From Linear Model to Deep Learning/mnist/part1")
from utils import *
...
# for lambda_val in [1,0.1,0.01]:
#     print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=lambda_val))
...
#for tem_param in [.5, 1.0, 2.0]:
#    print('softmax test_error=', run_softmax_on_MNIST(temp_parameter=tem_param),"with temperature",tem_param)
#######################################################################
# 6. Changing Labels
#######################################################################
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    # YOUR CODE HERE
    train_x, train_y, test_x, test_y = get_MNIST_data()
    #test_y = np.array([label % 3 for label in test_y])
